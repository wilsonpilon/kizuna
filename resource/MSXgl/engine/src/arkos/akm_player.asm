...
PLY_AKM_DATA_OFFSETPITCHCURRENTSTEP = .+1
...
PLY_AKM_PERIODTABLE:
    ...
    .dw 0xeff
    .dw 0xe28
PLY_AKM_CHANNEL1_SOUNDEFFECTDATA = ARKOS_ADDR(0xf057)
PLY_AKM_CHANNEL2_SOUNDEFFECTDATA = ARKOS_ADDR(0xf05f)
PLY_AKM_CHANNEL3_SOUNDEFFECTDATA = ARKOS_ADDR(0xf067)
PLY_AKM_DEFAULTSTARTINSTRUMENTINTRACKS = ARKOS_ADDR(0xf00f)
PLY_AKM_DEFAULTSTARTNOTEINTRACKS = ARKOS_ADDR(0xf00e)
PLY_AKM_DEFAULTSTARTWAITINTRACKS = ARKOS_ADDR(0xf010)
PLY_AKM_FLAGNOTEANDEFFECTINCELL = ARKOS_ADDR(0xf015)
PLY_AKM_LINKERPREVIOUSREMAININGHEIGHT = ARKOS_ADDR(0xf017)
PLY_AKM_MIXERREGISTER = ARKOS_ADDR(0xf046)
PLY_AKM_NOISEREGISTER = ARKOS_ADDR(0xf042)
PLY_AKM_NOTEINDEXTABLE = ARKOS_ADDR(0xf008)
PLY_AKM_PATTERNREMAININGHEIGHT = ARKOS_ADDR(0xf016)
PLY_AKM_PRIMARYINSTRUMENT = ARKOS_ADDR(0xf011)
PLY_AKM_PRIMARYWAIT = ARKOS_ADDR(0xf013)
PLY_AKM_PTARPEGGIOS = ARKOS_ADDR(0xf002)
PLY_AKM_PTINSTRUMENTS = ARKOS_ADDR(0xf000)
PLY_AKM_PTLINKER = ARKOS_ADDR(0xf006)
PLY_AKM_PTPITCHES = ARKOS_ADDR(0xf004)
PLY_AKM_PTSOUNDEFFECTTABLE = ARKOS_ADDR(0xf055)
PLY_AKM_REG11 = ARKOS_ADDR(0xf04a)
PLY_AKM_REG12 = ARKOS_ADDR(0xf04e)
PLY_AKM_RT_READEFFECTSFLAG = ARKOS_ADDR(0xf01c)
PLY_AKM_SAVESP = ARKOS_ADDR(0xf00c)
PLY_AKM_SECONDARYINSTRUMENT = ARKOS_ADDR(0xf012)
PLY_AKM_SECONDARYWAIT = ARKOS_ADDR(0xf014)
PLY_AKM_SETREG13 = ARKOS_ADDR(0xf01b)
PLY_AKM_SETREG13OLD = ARKOS_ADDR(0xf01a)
PLY_AKM_SPEED = ARKOS_ADDR(0xf018)
PLY_AKM_TICKCOUNTER = ARKOS_ADDR(0xf019)
PLY_AKM_TRACK1_ESCAPEINSTRUMENT = ARKOS_ADDR(0xf074)
PLY_AKM_TRACK1_ESCAPENOTE = ARKOS_ADDR(0xf073)
PLY_AKM_TRACK1_ESCAPEWAIT = ARKOS_ADDR(0xf075)
PLY_AKM_TRACK1_PTINSTRUMENT = ARKOS_ADDR(0xf076)
PLY_AKM_TRACK1_REGISTERS = ARKOS_ADDR(0xf01d)
PLY_AKM_TRACK1_TRANSPOSITION = ARKOS_ADDR(0xf06d)
PLY_AKM_TRACK1_VOLUME = ARKOS_ADDR(0xf01e)
PLY_AKM_TRACK1_WAITEMPTYCELL = ARKOS_ADDR(0xf06c)
PLY_AKM_TRACK2_ESCAPEINSTRUMENT = ARKOS_ADDR(0xf09a)
PLY_AKM_TRACK2_ESCAPENOTE = ARKOS_ADDR(0xf099)
PLY_AKM_TRACK2_ESCAPEWAIT = ARKOS_ADDR(0xf09b)
PLY_AKM_TRACK2_PTINSTRUMENT = ARKOS_ADDR(0xf09c)
PLY_AKM_TRACK2_REGISTERS = ARKOS_ADDR(0xf029)
PLY_AKM_TRACK2_VOLUME = ARKOS_ADDR(0xf02a)
PLY_AKM_TRACK2_WAITEMPTYCELL = ARKOS_ADDR(0xf092)
PLY_AKM_TRACK3_ESCAPEINSTRUMENT = ARKOS_ADDR(0xf0c0)
PLY_AKM_TRACK3_ESCAPENOTE = ARKOS_ADDR(0xf0bf)
PLY_AKM_TRACK3_ESCAPEWAIT = ARKOS_ADDR(0xf0c1)
PLY_AKM_TRACK3_PTINSTRUMENT = ARKOS_ADDR(0xf0c2)
PLY_AKM_TRACK3_REGISTERS = ARKOS_ADDR(0xf035)
PLY_AKM_TRACK3_VOLUME = ARKOS_ADDR(0xf036)
PLY_AKM_TRACK3_WAITEMPTYCELL = ARKOS_ADDR(0xf0b8)
PLY_AKM_TRACKINDEX = ARKOS_ADDR(0xf00a)
