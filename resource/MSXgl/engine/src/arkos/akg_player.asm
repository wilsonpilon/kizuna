...
PLY_AKG_PSES_SOFTWAREORSOFTWAREANDHARDWARE:
    ...
    call PLY_AKG_PSES_MANAGEVOLUMEFROMA_FILTER4BITS
    rl b
PLY_AKG_OPCODE_SUB_IMMEDIATE = .+2
    call PLY_AKG_PSES_READNOISEIFNEEDEDANDOPENORCLOSENOISECHANNEL
    res 2,c
...
PLY_AKG_PERIODTABLE:
    ...
    .dw 0x5
    .dw 0x4
PLY_AKG_ARPEGGIOSTABLE = ARKOS_ADDR(0xf011)
PLY_AKG_BASENOTEINDEX = ARKOS_ADDR(0xf002)
PLY_AKG_CHANNEL1_ARPEGGIOBASESPEED = ARKOS_ADDR(0xf03c)
PLY_AKG_CHANNEL1_ARPEGGIOTABLE = ARKOS_ADDR(0xf048)
PLY_AKG_CHANNEL1_ARPEGGIOTABLEBASE = ARKOS_ADDR(0xf04a)
PLY_AKG_CHANNEL1_ARPEGGIOTABLECURRENTSTEP = ARKOS_ADDR(0xf03a)
PLY_AKG_CHANNEL1_ARPEGGIOTABLESPEED = ARKOS_ADDR(0xf03d)
PLY_AKG_CHANNEL1_GENERATEDCURRENTARPNOTE = ARKOS_ADDR(0xf03b)
PLY_AKG_CHANNEL1_GENERATEDCURRENTINVERTEDVOLUME = ARKOS_ADDR(0xf045)
PLY_AKG_CHANNEL1_GENERATEDCURRENTPITCH = ARKOS_ADDR(0xf069)
PLY_AKG_CHANNEL1_GLIDEDIRECTION = ARKOS_ADDR(0xf044)
PLY_AKG_CHANNEL1_GLIDETOREACH = ARKOS_ADDR(0xf060)
PLY_AKG_CHANNEL1_GLIDE_SAVEHL = ARKOS_ADDR(0xf062)
PLY_AKG_CHANNEL1_INSTRUMENTORIGINALSPEED = ARKOS_ADDR(0xf037)
PLY_AKG_CHANNEL1_INSTRUMENTSPEED = ARKOS_ADDR(0xf038)
PLY_AKG_CHANNEL1_INSTRUMENTSTEP = ARKOS_ADDR(0xf039)
PLY_AKG_CHANNEL1_INVERTEDVOLUMEINTEGER = ARKOS_ADDR(0xf057)
PLY_AKG_CHANNEL1_INVERTEDVOLUMEINTEGERANDDECIMAL = ARKOS_ADDR(0xf056)
PLY_AKG_CHANNEL1_ISARPEGGIOTABLE = ARKOS_ADDR(0xf034)
PLY_AKG_CHANNEL1_ISPITCH = ARKOS_ADDR(0xf036)
PLY_AKG_CHANNEL1_ISPITCHTABLE = ARKOS_ADDR(0xf035)
PLY_AKG_CHANNEL1_ISVOLUMESLIDE = ARKOS_ADDR(0xf033)
PLY_AKG_CHANNEL1_PITCH = ARKOS_ADDR(0xf058)
PLY_AKG_CHANNEL1_PITCHBASESPEED = ARKOS_ADDR(0xf03f)
PLY_AKG_CHANNEL1_PITCHTABLE = ARKOS_ADDR(0xf04e)
PLY_AKG_CHANNEL1_PITCHTABLEBASE = ARKOS_ADDR(0xf050)
PLY_AKG_CHANNEL1_PITCHTABLECURRENTSTEP = ARKOS_ADDR(0xf03e)
PLY_AKG_CHANNEL1_PITCHTABLESPEED = ARKOS_ADDR(0xf040)
PLY_AKG_CHANNEL1_PITCHTRACK = ARKOS_ADDR(0xf04c)
PLY_AKG_CHANNEL1_PITCHTRACKADDORSBC_16BITS = ARKOS_ADDR(0xf06b)
PLY_AKG_CHANNEL1_PITCHTRACKAFTERADDORSBCJUMPINSTRANDADDRESS = ARKOS_ADDR(0xf06d)
PLY_AKG_CHANNEL1_PITCHTRACKDECIMALCOUNTER = ARKOS_ADDR(0xf042)
PLY_AKG_CHANNEL1_PITCHTRACKDECIMALINSTR = ARKOS_ADDR(0xf064)
PLY_AKG_CHANNEL1_PITCHTRACKDECIMALINSTRANDVALUERETURNJP = ARKOS_ADDR(0xf066)
PLY_AKG_CHANNEL1_PITCHTRACKDECIMALVALUE = ARKOS_ADDR(0xf065)
PLY_AKG_CHANNEL1_PITCHTRACKINTEGERADDORSUB = ARKOS_ADDR(0xf070)
PLY_AKG_CHANNEL1_PITCHTRACKINTEGERAFTERADDORSUBJUMPINSTRANDADDRESS = ARKOS_ADDR(0xf071)
PLY_AKG_CHANNEL1_PTBASEINSTRUMENT = ARKOS_ADDR(0xf05c)
PLY_AKG_CHANNEL1_PTINSTRUMENT = ARKOS_ADDR(0xf05a)
PLY_AKG_CHANNEL1_PTTRACK = ARKOS_ADDR(0xf046)
PLY_AKG_CHANNEL1_SOUNDEFFECTDATA = ARKOS_ADDR(0xf0fc)
PLY_AKG_CHANNEL1_SOUNDSTREAM_RELATIVEMODIFIERADDRESS = ARKOS_ADDR(0xf031)
PLY_AKG_CHANNEL1_TRACKNOTE = ARKOS_ADDR(0xf043)
PLY_AKG_CHANNEL1_VOLUMESLIDEVALUE = ARKOS_ADDR(0xf05e)
PLY_AKG_CHANNEL1_WAITCOUNTER = ARKOS_ADDR(0xf032)
PLY_AKG_CHANNEL2_ARPEGGIOBASESPEED = ARKOS_ADDR(0xf07f)
PLY_AKG_CHANNEL2_ARPEGGIOTABLE = ARKOS_ADDR(0xf08b)
PLY_AKG_CHANNEL2_ARPEGGIOTABLEBASE = ARKOS_ADDR(0xf08d)
PLY_AKG_CHANNEL2_ARPEGGIOTABLECURRENTSTEP = ARKOS_ADDR(0xf07d)
PLY_AKG_CHANNEL2_ARPEGGIOTABLESPEED = ARKOS_ADDR(0xf080)
PLY_AKG_CHANNEL2_GENERATEDCURRENTARPNOTE = ARKOS_ADDR(0xf07e)
PLY_AKG_CHANNEL2_GENERATEDCURRENTINVERTEDVOLUME = ARKOS_ADDR(0xf088)
PLY_AKG_CHANNEL2_GENERATEDCURRENTPITCH = ARKOS_ADDR(0xf0ac)
PLY_AKG_CHANNEL2_GLIDEDIRECTION = ARKOS_ADDR(0xf087)
PLY_AKG_CHANNEL2_GLIDETOREACH = ARKOS_ADDR(0xf0a3)
PLY_AKG_CHANNEL2_GLIDE_SAVEHL = ARKOS_ADDR(0xf0a5)
PLY_AKG_CHANNEL2_INSTRUMENTORIGINALSPEED = ARKOS_ADDR(0xf07a)
PLY_AKG_CHANNEL2_INSTRUMENTSPEED = ARKOS_ADDR(0xf07b)
PLY_AKG_CHANNEL2_INSTRUMENTSTEP = ARKOS_ADDR(0xf07c)
PLY_AKG_CHANNEL2_INVERTEDVOLUMEINTEGER = ARKOS_ADDR(0xf09a)
PLY_AKG_CHANNEL2_INVERTEDVOLUMEINTEGERANDDECIMAL = ARKOS_ADDR(0xf099)
PLY_AKG_CHANNEL2_ISARPEGGIOTABLE = ARKOS_ADDR(0xf077)
PLY_AKG_CHANNEL2_ISPITCH = ARKOS_ADDR(0xf079)
PLY_AKG_CHANNEL2_ISPITCHTABLE = ARKOS_ADDR(0xf078)
PLY_AKG_CHANNEL2_ISVOLUMESLIDE = ARKOS_ADDR(0xf076)
PLY_AKG_CHANNEL2_PITCH = ARKOS_ADDR(0xf09b)
PLY_AKG_CHANNEL2_PITCHBASESPEED = ARKOS_ADDR(0xf082)
PLY_AKG_CHANNEL2_PITCHTABLE = ARKOS_ADDR(0xf091)
PLY_AKG_CHANNEL2_PITCHTABLEBASE = ARKOS_ADDR(0xf093)
PLY_AKG_CHANNEL2_PITCHTABLECURRENTSTEP = ARKOS_ADDR(0xf081)
PLY_AKG_CHANNEL2_PITCHTABLESPEED = ARKOS_ADDR(0xf083)
PLY_AKG_CHANNEL2_PITCHTRACK = ARKOS_ADDR(0xf08f)
PLY_AKG_CHANNEL2_PITCHTRACKADDORSBC_16BITS = ARKOS_ADDR(0xf0ae)
PLY_AKG_CHANNEL2_PITCHTRACKAFTERADDORSBCJUMPINSTRANDADDRESS = ARKOS_ADDR(0xf0b0)
PLY_AKG_CHANNEL2_PITCHTRACKDECIMALCOUNTER = ARKOS_ADDR(0xf085)
PLY_AKG_CHANNEL2_PITCHTRACKDECIMALINSTR = ARKOS_ADDR(0xf0a7)
PLY_AKG_CHANNEL2_PITCHTRACKDECIMALINSTRANDVALUERETURNJP = ARKOS_ADDR(0xf0a9)
PLY_AKG_CHANNEL2_PITCHTRACKDECIMALVALUE = ARKOS_ADDR(0xf0a8)
PLY_AKG_CHANNEL2_PITCHTRACKINTEGERADDORSUB = ARKOS_ADDR(0xf0b3)
PLY_AKG_CHANNEL2_PITCHTRACKINTEGERAFTERADDORSUBJUMPINSTRANDADDRESS = ARKOS_ADDR(0xf0b4)
PLY_AKG_CHANNEL2_PLAYINSTRUMENT_RELATIVEMODIFIERADDRESS = ARKOS_ADDR(0xf074)
PLY_AKG_CHANNEL2_PTBASEINSTRUMENT = ARKOS_ADDR(0xf09f)
PLY_AKG_CHANNEL2_PTINSTRUMENT = ARKOS_ADDR(0xf09d)
PLY_AKG_CHANNEL2_PTTRACK = ARKOS_ADDR(0xf089)
PLY_AKG_CHANNEL2_SOUNDEFFECTDATA = ARKOS_ADDR(0xf104)
PLY_AKG_CHANNEL2_TRACKNOTE = ARKOS_ADDR(0xf086)
PLY_AKG_CHANNEL2_VOLUMESLIDEVALUE = ARKOS_ADDR(0xf0a1)
PLY_AKG_CHANNEL2_WAITCOUNTER = ARKOS_ADDR(0xf075)
PLY_AKG_CHANNEL3_ARPEGGIOBASESPEED = ARKOS_ADDR(0xf0c2)
PLY_AKG_CHANNEL3_ARPEGGIOTABLE = ARKOS_ADDR(0xf0ce)
PLY_AKG_CHANNEL3_ARPEGGIOTABLEBASE = ARKOS_ADDR(0xf0d0)
PLY_AKG_CHANNEL3_ARPEGGIOTABLECURRENTSTEP = ARKOS_ADDR(0xf0c0)
PLY_AKG_CHANNEL3_ARPEGGIOTABLESPEED = ARKOS_ADDR(0xf0c3)
PLY_AKG_CHANNEL3_GENERATEDCURRENTARPNOTE = ARKOS_ADDR(0xf0c1)
PLY_AKG_CHANNEL3_GENERATEDCURRENTINVERTEDVOLUME = ARKOS_ADDR(0xf0cb)
PLY_AKG_CHANNEL3_GENERATEDCURRENTPITCH = ARKOS_ADDR(0xf0ef)
PLY_AKG_CHANNEL3_GLIDEDIRECTION = ARKOS_ADDR(0xf0ca)
PLY_AKG_CHANNEL3_GLIDETOREACH = ARKOS_ADDR(0xf0e6)
PLY_AKG_CHANNEL3_GLIDE_SAVEHL = ARKOS_ADDR(0xf0e8)
PLY_AKG_CHANNEL3_INSTRUMENTORIGINALSPEED = ARKOS_ADDR(0xf0bd)
PLY_AKG_CHANNEL3_INSTRUMENTSPEED = ARKOS_ADDR(0xf0be)
PLY_AKG_CHANNEL3_INSTRUMENTSTEP = ARKOS_ADDR(0xf0bf)
PLY_AKG_CHANNEL3_INVERTEDVOLUMEINTEGER = ARKOS_ADDR(0xf0dd)
PLY_AKG_CHANNEL3_INVERTEDVOLUMEINTEGERANDDECIMAL = ARKOS_ADDR(0xf0dc)
PLY_AKG_CHANNEL3_ISARPEGGIOTABLE = ARKOS_ADDR(0xf0ba)
PLY_AKG_CHANNEL3_ISPITCH = ARKOS_ADDR(0xf0bc)
PLY_AKG_CHANNEL3_ISPITCHTABLE = ARKOS_ADDR(0xf0bb)
PLY_AKG_CHANNEL3_ISVOLUMESLIDE = ARKOS_ADDR(0xf0b9)
PLY_AKG_CHANNEL3_PITCH = ARKOS_ADDR(0xf0de)
PLY_AKG_CHANNEL3_PITCHBASESPEED = ARKOS_ADDR(0xf0c5)
PLY_AKG_CHANNEL3_PITCHTABLE = ARKOS_ADDR(0xf0d4)
PLY_AKG_CHANNEL3_PITCHTABLEBASE = ARKOS_ADDR(0xf0d6)
PLY_AKG_CHANNEL3_PITCHTABLECURRENTSTEP = ARKOS_ADDR(0xf0c4)
PLY_AKG_CHANNEL3_PITCHTABLESPEED = ARKOS_ADDR(0xf0c6)
PLY_AKG_CHANNEL3_PITCHTRACK = ARKOS_ADDR(0xf0d2)
PLY_AKG_CHANNEL3_PITCHTRACKADDORSBC_16BITS = ARKOS_ADDR(0xf0f1)
PLY_AKG_CHANNEL3_PITCHTRACKAFTERADDORSBCJUMPINSTRANDADDRESS = ARKOS_ADDR(0xf0f3)
PLY_AKG_CHANNEL3_PITCHTRACKDECIMALCOUNTER = ARKOS_ADDR(0xf0c8)
PLY_AKG_CHANNEL3_PITCHTRACKDECIMALINSTR = ARKOS_ADDR(0xf0ea)
PLY_AKG_CHANNEL3_PITCHTRACKDECIMALINSTRANDVALUERETURNJP = ARKOS_ADDR(0xf0ec)
PLY_AKG_CHANNEL3_PITCHTRACKDECIMALVALUE = ARKOS_ADDR(0xf0eb)
PLY_AKG_CHANNEL3_PITCHTRACKINTEGERADDORSUB = ARKOS_ADDR(0xf0f6)
PLY_AKG_CHANNEL3_PITCHTRACKINTEGERAFTERADDORSUBJUMPINSTRANDADDRESS = ARKOS_ADDR(0xf0f7)
PLY_AKG_CHANNEL3_PTBASEINSTRUMENT = ARKOS_ADDR(0xf0e2)
PLY_AKG_CHANNEL3_PTINSTRUMENT = ARKOS_ADDR(0xf0e0)
PLY_AKG_CHANNEL3_PTTRACK = ARKOS_ADDR(0xf0cc)
PLY_AKG_CHANNEL3_SOUNDEFFECTDATA = ARKOS_ADDR(0xf10c)
PLY_AKG_CHANNEL3_SOUNDSTREAM_RELATIVEMODIFIERADDRESS = ARKOS_ADDR(0xf0b7)
PLY_AKG_CHANNEL3_TRACKNOTE = ARKOS_ADDR(0xf0c9)
PLY_AKG_CHANNEL3_VOLUMESLIDEVALUE = ARKOS_ADDR(0xf0e4)
PLY_AKG_CHANNEL3_WAITCOUNTER = ARKOS_ADDR(0xf0b8)
PLY_AKG_CHANNEL_READEFFECTS_EFFECTBLOCKS1 = ARKOS_ADDR(0xf017)
PLY_AKG_CHANNEL_READEFFECTS_ENDJUMPINSTRANDADDRESS = ARKOS_ADDR(0xf029)
PLY_AKG_CHANNEL_RE_READNEXTEFFECTINBLOCK = ARKOS_ADDR(0xf00a)
PLY_AKG_CURRENTSPEED = ARKOS_ADDR(0xf001)
PLY_AKG_EFFECT_GLIDEWITHNOTESAVEDE = ARKOS_ADDR(0xf02c)
PLY_AKG_EMPTYINSTRUMENTDATAPT = ARKOS_ADDR(0xf019)
PLY_AKG_EVENT = ARKOS_ADDR(0xf000)
PLY_AKG_EVENTTRACK_PTTRACK = ARKOS_ADDR(0xf00f)
PLY_AKG_EVENTTRACK_WAITCOUNTER = ARKOS_ADDR(0xf006)
PLY_AKG_INSTRUMENTSTABLE = ARKOS_ADDR(0xf015)
PLY_AKG_PATTERNDECREASINGHEIGHT = ARKOS_ADDR(0xf003)
PLY_AKG_PITCHESTABLE = ARKOS_ADDR(0xf013)
PLY_AKG_PSGHARDWAREPERIOD_INSTR = ARKOS_ADDR(0xf027)
PLY_AKG_PSGREG01_INSTR = ARKOS_ADDR(0xf01d)
PLY_AKG_PSGREG10 = ARKOS_ADDR(0xf026)
PLY_AKG_PSGREG13_INSTR = ARKOS_ADDR(0xf008)
PLY_AKG_PSGREG13_OLDVALUE = ARKOS_ADDR(0xf007)
PLY_AKG_PSGREG23_INSTR = ARKOS_ADDR(0xf01f)
PLY_AKG_PSGREG45_INSTR = ARKOS_ADDR(0xf021)
PLY_AKG_PSGREG6_8_INSTR = ARKOS_ADDR(0xf023)
PLY_AKG_PSGREG8 = ARKOS_ADDR(0xf024)
PLY_AKG_PSGREG9_10_INSTR = ARKOS_ADDR(0xf025)
PLY_AKG_PTSOUNDEFFECTTABLE = ARKOS_ADDR(0xf0fa)
PLY_AKG_READLINKER_PTLINKER = ARKOS_ADDR(0xf00b)
PLY_AKG_RETRIG = ARKOS_ADDR(0xf009)
PLY_AKG_SAVESP = ARKOS_ADDR(0xf01b)
PLY_AKG_SPEEDTRACK_PTTRACK = ARKOS_ADDR(0xf00d)
PLY_AKG_SPEEDTRACK_WAITCOUNTER = ARKOS_ADDR(0xf005)
PLY_AKG_TEMPPLAYINSTRUMENTJUMPINSTRANDADDRESS = ARKOS_ADDR(0xf02e)
PLY_AKG_TICKDECREASINGCOUNTER = ARKOS_ADDR(0xf004)
