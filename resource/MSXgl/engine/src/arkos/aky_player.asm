...
PLY_AKY_PSGREGISTER_OFFSETREGISTERVOLUME:
    ...
    ld a,(hl)
    inc hl
PLY_AKY_PSG1SOFTWAREREGISTERARRAY_SIZE = .+2
    ld de,#0x4
    add hl,de
...
PLY_AKY_CHANNEL2_WAITBEFORENEXTREGISTERBLOCK_OVER:
	ld a,#0x0
    ld (PLY_AKY_CHANNEL2_REGISTERBLOCKLINESTATE_OPCODE),a
PLY_AKY_PLAYCITY_SELECTWRITE_PORT_LSB_RIGHT = .+1
...
PLY_AKY_PLAYCITY_WRITE_PORT_MSB:
	ld a,#0xff
    ld (PLY_AKY_CHANNEL3_REGISTERBLOCKLINESTATE_OPCODE),a
PLY_AKY_TURBOSOUND_PSG2_REGISTER = .+1
PLY_AKY_PCW_TURBOSOUND_PSGNUMBER2_SELECTION_VALUE = .+1
PLY_AKY_SPECNEXT_PSG2_REGISTER = .+1
PLY_AKY_OPCODE_SCF = .+2
PLY_AKY_TURBOSOUND_PSG1_REGISTER = .+2
PLY_AKY_SPECNEXT_PSG1_REGISTER = .+2
PLY_AKY_PCW_TURBOSOUND_PSGNUMBER1_SELECTION_VALUE = .+2
PLY_AKY_SPECNEXT_PSG3_REGISTER:
	ld (PLY_AKY_CHANNEL3_PTREGISTERBLOCK),hl
...
PLY_AKY_CHANNEL1_PTREGISTERBLOCK = ARKOS_ADDR(0xf01e)
PLY_AKY_CHANNEL1_PTTRACK = ARKOS_ADDR(0xf018)
PLY_AKY_CHANNEL1_REGISTERBLOCKLINESTATE_OPCODE = ARKOS_ADDR(0xf027)
PLY_AKY_CHANNEL1_WAITBEFORENEXTREGISTERBLOCK = ARKOS_ADDR(0xf024)
PLY_AKY_CHANNEL2_PTREGISTERBLOCK = ARKOS_ADDR(0xf020)
PLY_AKY_CHANNEL2_PTTRACK = ARKOS_ADDR(0xf01a)
PLY_AKY_CHANNEL2_REGISTERBLOCKLINESTATE_OPCODE = ARKOS_ADDR(0xf028)
PLY_AKY_CHANNEL2_WAITBEFORENEXTREGISTERBLOCK = ARKOS_ADDR(0xf025)
PLY_AKY_CHANNEL3_PTREGISTERBLOCK = ARKOS_ADDR(0xf022)
PLY_AKY_CHANNEL3_PTTRACK = ARKOS_ADDR(0xf01c)
PLY_AKY_CHANNEL3_REGISTERBLOCKLINESTATE_OPCODE = ARKOS_ADDR(0xf029)
PLY_AKY_CHANNEL3_WAITBEFORENEXTREGISTERBLOCK = ARKOS_ADDR(0xf026)
PLY_AKY_PATTERNFRAMECOUNTER = ARKOS_ADDR(0xf016)
PLY_AKY_PSG1HARDWAREREGISTERARRAY = ARKOS_ADDR(0xf00b)
PLY_AKY_PSG1HARDWAREREGISTERARRAY_END = ARKOS_ADDR(0xf010)
PLY_AKY_PSG1REGISTER0 = ARKOS_ADDR(0xf000)
PLY_AKY_PSG1REGISTER2 = ARKOS_ADDR(0xf002)
PLY_AKY_PSG1REGISTER4 = ARKOS_ADDR(0xf004)
PLY_AKY_SAVESP = ARKOS_ADDR(0xf012)
