...
;------------------------------------------------------------------------------
; Install ISR in RAM; either in page 0 (with optional code/data copy there) or in page 3 to use with IM2
RAMISR_NONE			= 0				; Don't install ISR in RAM
RAMISR_PAGE0		= 1				; Install ISR in page 0
RAMISR_SEGMENT0		= 2				; Install ISR and segment data (for mapped-ROM) in page 0
RAMISR_PAGE3		= 3				; Install ISR in page 3 (to use with IM2)
...
ROM_RAMISR			= RAMISR_NONE	; Install ISR in RAM's page 0
...
BIOS_RELEASE    	= 0				; Event called before BIOS is released
