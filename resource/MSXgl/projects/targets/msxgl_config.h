...
#define INPUT_KB_AS_JOYSTICK		FALSE	// Add function to read keyboard state as joystick input (see Keyboard_ReadAsJoystick)
// Key update handler
...
#define DOS_USE_ERROR_HANDLER		FALSE	// Add support for MSX-DOS 1 error handler callback
#define DOS_USE_BIOSCALL			FALSE	// Add support for call to BIOS routines
