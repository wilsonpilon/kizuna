# =============================================================================
# KIZUNA - Script de Build do Exemplo de I/O de Arquivo (BDOS_File*)
# =============================================================================
...
Write-Host "    KIZUNA - Build do Exemplo de I/O de Arquivo                  " -ForegroundColor Cyan
Write-Host "=================================================================" -ForegroundColor Cyan

# 1. Montar main.asm
$asmFile = Join-Path $SampleDir "main.asm"
$mobFile = Join-Path $SampleDir "main.mob"
$logFile = Join-Path $SampleDir "fileio.log"
...
$outCom = Join-Path $SampleDir "fileio.com"
$mapFile = Join-Path $SampleDir "fileio.map"
