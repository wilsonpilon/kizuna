# =============================================================================
# KIZUNA - Script de Build do Exemplo do motor de comandos do VDP (VDP_Hw*)
# =============================================================================
...
Write-Host "    KIZUNA - Build do Exemplo do motor de comandos do VDP                         " -ForegroundColor Cyan
Write-Host "=================================================================" -ForegroundColor Cyan

# 1. Montar main.asm
$asmFile = Join-Path $SampleDir "main.asm"
$mobFile = Join-Path $SampleDir "main.mob"
$logFile = Join-Path $SampleDir "vdpcmd.log"
...
$outCom = Join-Path $SampleDir "vdpcmd.com"
$mapFile = Join-Path $SampleDir "vdpcmd.map"
