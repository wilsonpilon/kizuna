...
para MSX2 (Z80, MSX-DOS, 128Kb de RAM com memory mapper), permitindo escrever
...
- MSX-DOS é compatível a nível de BDOS com CP/M-80, o que já permitia,
  ...
  REL da Microsoft).
- Turbo Pascal 3 rodava em CP/M-80 (Z80); Turbo Pascal 4 introduziu units,
  mas ficou restrito a MS-DOS/x86. Não existe hoje um Pascal moderno,
  fiel ao TP4 (com units), gerando `.COM` nativo para MSX2.
- O objetivo final é uma linguagem melhor que o TP3/TP4 originais **porque**
  passa a usar os 128Kb de RAM com bank switching — algo que os compiladores
...
|-------------------|----------------------------------------------------|
| CPU               | Z80                                                 |
| Sistema            | MSX-DOS (1 ou 2)                                    |
| Memória            | 128Kb RAM com memory mapper                         |
...
```
0000h-3FFFh  Página 0  Fixa — reservada para MSX-DOS/BIOS
